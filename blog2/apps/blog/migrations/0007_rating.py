    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.IntegerField(choices=[(1, 'Нравится'), (-1, 'Не нравится')], verbose_name='Показатель')),
                ('time_create', models.DateTimeField(auto_now_add=True, verbose_name='Время установки')),
